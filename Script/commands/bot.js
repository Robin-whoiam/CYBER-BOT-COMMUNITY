...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     return api.sendMessage("Ummah", threadID);
   };
   
    if ((event.body.toLowerCase() == "👍🏼") || (event.body.toLowerCase() == "👍")) {
     return api.sendMessage("সর এখান থেকে লাইকার আবা*..!🐸🤣👍⛏️", threadID);
   };
  
   if ((event.body.toLowerCase() == "Botla") || (event.body.toLowerCase() == "botla")) {
     return api.sendMessage("তোরে আমি শান্তি দিমু☺️😇 পাসপোর্ট ছাড়া ভিসা দিমু😾🔪", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Robin") || (event.body.toLowerCase() == "robin") || (event.body.toLowerCase() == "@RobiN ッ") || (event.body.toLowerCase() == "রবিন")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami Robin") || (event.body.toLowerCase() == "cup sala ami RobiN") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "Moyna") || (event.body.toLowerCase() == "moyna")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা আমার বস রবিন এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Munni") || (event.body.toLowerCase() == "munni")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা মিরাজুল এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Rajmin") || (event.body.toLowerCase() == "rajmin")) {
     return api.sendMessage("খবরদার কেউ এই নাম ধরে ডাক দিবানা এটা মোহন এর বারো ভাতারি বউ এর নাম..!😠🥰🫦", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>NiceTryDiddy Bot", threadID);
   };
